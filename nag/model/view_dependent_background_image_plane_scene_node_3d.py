...
class ViewDependentBackgroundImagePlaneSceneNode3D(
    ...
    def __init__(
        self,
            ...
            view_dependence_output_dims: int = 3,
    ...
    def estimate_view_dependence_scaling(self, normalization: FittableTransform):
        ...
        with torch.no_grad():
            ...
            view_field = self.get_view_dependence(uv_vec[:, None, :],
                                                  ...
                                                  sin_epoch=torch.tensor(0., device=device, dtype=self._translation.dtype)).reshape(V * H * W, 3)
    ...
    def get_view_dependence(self,
        ...
        view_dependence = view_dependence.reshape(B, T, 3)
