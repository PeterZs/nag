...
from nag.sampling.timed_weighted_uv_grid_sampler


class TimedUVGridSampler(Dataset, TorchDtypeMixin):
    ...
    def plot_rays(self, batch_idx: int | List[int], camera: TimedCameraSceneNode3D) -> Figure:
